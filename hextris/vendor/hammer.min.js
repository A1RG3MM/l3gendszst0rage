...
!function(a, b) {
    ...
    var r = d.utils = {
        ...
        setPrefixedCss: function(a, b, c, d) {
            ...
            for (var f = 0; f < e.length; f++) {
                var g = b;
                if (e[f] && (g = e[f] + g.slice(0, 1).toUpperCase() + g.slice(1)),
                g in a.style) {
      ...
      , u = d.detection = {
        ...
        getCalculatedData: function(a, b, c, e, f) {
            var g = this.current
              ...
              , i = g.lastCalcEvent
              , j = g.lastCalcData;
            i && a.timeStamp - i.timeStamp > d.CALCULATE_INTERVAL && (b = i.center,
            ...
            (!g.lastCalcEvent || h) && (j.velocity = r.getVelocity(c, e, f),
        ...
        extendEventData: function(a) {
            var b = this.current
              , c = b.startEvent
              , d = b.lastEvent || c;
            (a.eventType == q || a.eventType == p) && (c.touches = [],
    ...
    d.Instance.prototype = {
        ...
        dispose: function() {
            var a, b;
            for (r.toggleBehavior(this.element, this.options.behavior, !1),
            a = -1; b = this.eventHandlers[++a]; )
        ...
        function b(b, d) {
            ...
            if (!(d.options.dragMaxTouches > 0 && b.touches.length > d.options.dragMaxTouches))
                ...
                case m:
                    ...
                    break;
                case n:
                    if (b.distance < d.options.dragMinDistance && e.name != a)
                        return;
                    ...
                    break;
                case p:
                    c && b.changedLength <= d.options.dragMaxTouches && (d.trigger(a + "end", b),
                    c = !1);
                    break;
                case o:
                    c = !1
    ...
    function(a) {
        function b(b, d) {
            ...
            case o:
                ...
                f = !1,
                i && i.name == a && e && e < g.doubleTapInterval && b.distance < g.doubleTapDistance && (d.trigger("doubletap", b),
                f = !0),
                (!f || g.tapAlways) && (h.name = a,
                d.trigger(h.name, b)))
            }
        }
        var c = !1;
    ...
    function(a) {
        function b(b, d) {
            ...
            case n:
                ...
                if (e < d.options.transformMinScale && f < d.options.transformMinRotation)
                    return;
                u.current.name = a,
                c || (d.trigger(a + "start", b),
                c = !0),
                ...
                e > d.options.transformMinScale && (d.trigger("pinch", b),
                d.trigger("pinch" + (b.scale < 1 ? "in" : "out"), b));
                break;
            case p:
                c && b.changedLength < 2 && (d.trigger(a + "end", b),
                c = !1)
            }
        }
        var c = !1;
