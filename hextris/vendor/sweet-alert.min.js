!function(e, t, n) {
    function o(e) {
        ...
        if (O(t.querySelectorAll(".sa-icon")),
        e.type && !u()) {
            ...
            if (!c)
                return f("Unknown alert type: " + e.type),
                !1;
        ...
        if (e.imageUrl) {
            ...
            if (e.imageSize) {
                var v = e.imageSize.toString().split("x")
                  ...
                  , g = v[1];
                b && g ? (p = b,
                y = g) : f("Parameter imageSize expects value with format WIDTHxHEIGHT, got " + e.imageSize)
            }
    ...
    v = b = function() {
        ...
        function u(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(a)) {
                ...
                9 === a ? (r = -1 === s ? I : s === D.length - 1 ? D[0] : D[s + 1],
                P(o),
                r.focus(),
                i(r, g.confirmButtonColor)) : (r = 13 === a || 32 === a ? -1 === s ? I : n : 27 === a && g.allowEscapeKey === !0 ? O : n,
                r !== n && N(r, o))
            }
        }
        function d(t) {
        ...
        var b = arguments[0];
        if (arguments[0] === n)
            return f("SweetAlert expects at least 1 attribute!"),
            !1;
        var g = r({}, S);
        ...
        case "object":
            if (arguments[0].title === n)
                return f('Missing "title" argument!'),
                !1;
        ...
        }, q = B.querySelectorAll("button"), A = 0; A < q.length; A++)
            q[A].onclick = E,
            q[A].onmouseover = E,
            q[A].onmouseout = E,
            q[A].onmousedown = E,
